    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header card-header-primary">
            ...
            (to be signed by intern, participating in the e-Yantra Summer Internship Program [eYSIP-2021])
        </div>
        <div class="card-body">
          <h4><b>
            I, <b>{{Auth::user()->name}}</b> participating in the e-Yantra Summer Internship Program (eYSIP-2021) conducted by the e-Yantra project of IIT Bombay, <br><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">eYSIP 2021 Declaration</h5>
