    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header card-header-primary">
            <h4 class="card-title">{{ __('eYDIP - Non Disclosure Agreement ') }}</h4>
            (to be signed by intern, participating in the e-Yantra Summer Internship Program [eYDIP])
        </div>
        <div class="card-body">
          <h4><b>
            I, <b>{{Auth::user()->name}}</b> participating in the e-Yantra Summer Internship Program (eYDIP) conducted by the e-Yantra project of IIT Bombay, <br><br>
            ...
            Declare that all documents and work products submitted by me are my original work. Wherever I have consulted other sources, I have provided appropriate references.</li>
             ...
             <li>Understand that Indian Institute of Technology Bombay and e-Yantra shall own all the code and content which is created during eYDIP or as a result thereof.</li>
             ...
             <li>Understand that I am not allowed to claim employment with e-Yantra or IIT Bombay on online social media platforms such as Facebook, LinkedIn etc without prior approval from e-Yantra. I am, however, allowed to claim association with e-Yantra as an e-YDIP Intern between the time frame of May 2021 - July 2021.</li>
             <li>Understand that eYDIP is a full-time commitment and I need to put in at least 40 hours of work per week. I also understand that I am not allowed to participate in any other internship/job while being an active eYDIP intern.</li>
             ...
             <li>Any publication arising from the work under eYDIP shall be duly acknowledged in a form and manner to the satisfaction of e-Yantra team, IIT Bombay and only submitted for publication after taking due written permission.</li>
           </ol>
          </b></h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">eYDIP Declaration</h5>
